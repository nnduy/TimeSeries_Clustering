...
# output:
# df_ts_visits - List of all chosen timeseries and their visitors
def get_hvd_3genres_3locations(df_3genres, df_3genres_3locations, df_hvd):
    print("Dataframe contains all  3 genres of 3 locations - df_3genres_3locations:\n", df_3genres_3locations)
...
visitor_df = imputing_all_timeseries(df_store_and_visit, IMPUTATION_METHOD_ARG, MAX_MISSING_PERCENTAGE[0])
...
corelation_genre_clusters(timeseries_hierachy_clustered)
